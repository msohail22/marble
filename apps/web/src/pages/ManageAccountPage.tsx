...
export function ManageAccountPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="text-gray-300 hover:text-orange-400 transition-colors flex items-center gap-2"
            >
              <LogOut size={16} />
              Logout
            </button>
      ...
      {notification && (
        <div
          className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3 rounded-lg shadow-xl border ${
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex items-center gap-4 mb-12">
          <div className="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center text-2xl font-bold text-white shadow-lg">
            {userInitials || "JD"}
          </div>
          <div>
            <h1 className="text-3xl font-bold text-white">{profile.name}</h1>
            <p className="text-gray-400">{profile.email} • Manage Profile & Security</p>
          </div>
        </div>
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
              <nav className="divide-y divide-gray-700">
                <button
                  ...
                  className={`w-full px-6 py-4 text-left transition-colors font-medium flex items-center gap-3 ${
                    activeTab === "all"
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white font-medium">{profile.plan}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm">Status</p>
                  <p className="text-green-400 font-medium">{profile.status}</p>
                </div>
                <div>
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
                ...
                {editingProfile ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                      <p className="text-gray-400 text-sm mb-1">Timezone</p>
                ...
                <div className="space-y-4">
                  {apiKeys.length === 0 ? (
                    ...
                    apiKeys.map((key) => (
                      <div
                        key={key.id}
                        className="bg-gray-700/50 border border-gray-600 rounded-lg p-4 flex items-center justify-between hover:bg-gray-700/80 transition-colors"
                      >
                        <div className="flex-1">
                          <h3 className="text-white font-medium">{key.name}</h3>
                          <p className="text-gray-400 text-sm font-mono select-all">
                            {key.key}
                          </p>
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-lg text-sm font-medium transition-colors border border-red-500/20 flex items-center gap-1"
                        >
                          <Trash2 size={14} />
                          Revoke
                        </button>
      ...
      {showDeleteModal && (
        ...
        >
          <div
            className="bg-gray-800 border border-red-500/30 rounded-lg p-6 max-w-md w-full shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
